...
function twitterAPI(tokens,resolveName, id, args){
	...
	var client = new Twitter({
			consumer_key: twitterToken.client.client_id,
			consumer_secret: twitterToken.client.client_secret,
			access_token_key: twitterToken.access_token,
			access_token_secret: twitterToken.refresh_token
		})
